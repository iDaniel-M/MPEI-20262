...
#include <stdint.h>  // Librería para utilizar tipos de datos de tamaño fijo (ej. uint8_t)
#include <stdbool.h> // Librería para utilizar booleanos (true/false)
...
// Prototipos de las funciones que manejan la lógica interna
